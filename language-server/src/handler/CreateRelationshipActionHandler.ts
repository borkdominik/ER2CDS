...
import { CreateRelationshipAction } from '../actions.js';
import { ER2CDSServices } from '../er2cds-module.js';
import { ER2CDSDiagramServer } from '../er2cds-diagram-server.js';
import { SModelElement } from 'sprotty-protocol';
import { NODE_RELATIONSHIP } from '../er2cds-diagram.js';

export class CreateRelationshipActionHandler {
    public handle(action: CreateRelationshipAction, server: ER2CDSDiagramServer, services: ER2CDSServices): Promise<void> {
